...
- Importare i dati di configurazione da un file. Per avviare l' **Importazione guidata dei dati di configurazione**, nel nodo **Elementi di configurazione** o **Linee di base di configurazione** nell'area di lavoro **Asset e conformità** fare clic su **Importa dati di configurazione**. Per altre informazioni, vedere [Importare i dati di configurazione](/sccm/compliance/deploy-use/import-configuration-data).
...
[Importare i dati di configurazione](/sccm/compliance/deploy-use/import-configuration-data)
