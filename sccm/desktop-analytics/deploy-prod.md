...
Dopo aver [eseguito la distribuzione in un progetto pilota](/sccm/desktop-analytics/deploy-pilot) e aver esaminato lo stato delle risorse, è possibile eseguire l'aggiornamento della parte restante dell'ambiente di produzione.
...
Per altre informazioni, vedere [Monitoraggio dello stato di integrità](/sccm/desktop-analytics/health-status-monitoring).
