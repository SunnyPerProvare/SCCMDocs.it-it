...
Configuration Manager Configura le impostazioni di Windows solo se un valore non esiste già. Se è necessario configurare impostazioni diverse per un gruppo di dispositivi univoco, è possibile usare [criteri di gruppo](#group-policy). Destinata dei criteri di gruppo impostazioni avranno precedenza sulle impostazioni di Configuration Manager.
