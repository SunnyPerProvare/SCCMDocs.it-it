---
title: Limitare l&quot;accesso in base ai rischi | System Center Configuration Manager
...
Le aziende e le organizzazioni necessitano di proteggere i dati riservati dalle minacce emergenti, incluse minacce fisiche, basate su app e basate sulla rete, nonché le vulnerabilità del sistema operativo.

In passato, le aziende e le organizzazioni hanno adottato una posizione attiva per la protezione dei computer dagli attacchi dannosi. Il settore emergente dei dispositivi mobili spesso manca di protezione. Sebbene le piattaforme mobili abbiano la protezione incorporata del sistema operativo basata su tecniche come l'isolamento delle app e gli archivi delle app consumer esaminate, queste piattaforme continuano a essere vulnerabili agli attacchi sofisticati. Poiché i dispositivi mobili vengono sempre più ampiamente usati dai dipendenti per lavoro e richiedono l'accesso a dati che possono essere riservati e importanti, questi dispositivi devono essere protetti da una vasta gamma di attacchi sofisticati.
