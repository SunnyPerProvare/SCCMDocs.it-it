...
2. Nel gruppo **Crea** della scheda **Home** scegliere **Crea profilo Wi-Fi**.  

3. Nella pagina **Generale** immettere un nome univoco e una descrizione per il profilo Wi-Fi.  Per usare le impostazioni da un altro profilo Wi-Fi, selezionare **Importa un elemento del profilo Wi-Fi esistente da un file**.  
...
4. In **Gravità della non conformità per i report** specificare il livello di gravità che viene segnalato se il profilo Wi-Fi risulta non conforme su dispositivi client, ad esempio se non è possibile installare il profilo. I livelli di gravità disponibili sono i seguenti:  
...
9. selezionare il metodo di crittografia usato dalla rete wireless.  

10. selezionare il tipo EAP che viene usato per l'autenticazione con la rete wireless.  

     Solo per i dispositivi Windows Phone: i tipi EAP **LEAP** e **EAP-FAST** non sono supportati.  

11. Fare clic su **Configura** per specificare le proprietà per il tipo EAP selezionato. Questa opzione potrebbe non essere disponibile per alcuni tipi EAP selezionati.  
...
12. Selezionare **Memorizza le credenziali utente a ogni accesso**per archiviare le credenziali utente in modo che gli utenti non debbano immetterle a ogni accesso.  
...
15. Nella pagina **Impostazioni proxy** selezionare **Configura impostazioni proxy per questo profilo Wi-Fi** se la rete wireless usa un server proxy e quindi fornire le informazioni di configurazione.  
