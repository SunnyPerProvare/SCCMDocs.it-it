...
|-------------|---------------|  
|Gli amministratori rivedono le informazioni disponibili sui concetti di base per Endpoint Protection in Configuration Manager.|Per informazioni generali sulla Endpoint Protection, vedere [Endpoint Protection](endpoint-protection.md).|  
