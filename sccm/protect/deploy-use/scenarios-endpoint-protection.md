...
|-------------|---------------|  
|Gli amministratori rivedono le informazioni disponibili sui concetti di base per Endpoint Protection in Configuration Manager.|Per informazioni generali su Endpoint Protection, vedere [Endpoint Protection in System Center Configuration Manager](endpoint-protection.md).|  
