...
Per altre informazioni sulla distribuzione del sistema operativo in Configuration Manager, vedere [Gestire le immagini del sistema operativo](/sccm/osd/get-started/manage-operating-system-images).
