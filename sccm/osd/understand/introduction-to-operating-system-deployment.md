...
##  <a name="a-namebkmkosdmethodsa-methods-to-deploy-operating-systems"></a><a name="BKMK_OSDMethods"></a> Metodi di distribuzione di sistemi operativi  
...
-   Computer in cui il client di Configuration Manager non è installato  
