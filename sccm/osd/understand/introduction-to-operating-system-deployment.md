...
##  <a name="BKMK_OSDeploymentProcess"></a> Processo di distribuzione del sistema operativo  
...
##  <a name="BKMK_OSDScenarios"></a> Scenari di distribuzione del sistema operativo  
...
##  <a name="BKMK_OSUpgradePackages"></a> Pacchetti di aggiornamento del sistema operativo  
...
##  <a name="BKMK_OSDMedia"></a> Supporti per distribuire i sistemi operativi  
...
##  <a name="BKMK_OSDUserState"></a> Salvare e ripristinare lo stato utente  
...
##  <a name="BKMK_TaskSequences"></a> Usare sequenze di attività per automatizzare i passaggi  
