...
- A partire da Configuration Manager versione 1906, verificare l'[impostazione client](/sccm/core/clients/deploy/about-client-settings#bkmk_du) **Enable Dynamic Update for feature updates** (Abilita aggiornamento dinamico per gli aggiornamenti delle funzionalità) per assicurarsi che sia appropriata per l'ambiente in uso. <!--4062619-->
 per l'ambiente in uso. <!--4062619-->
...
> [!NOTE]  
> È possibile gestire il comportamento relativo alle distribuzioni ad alto rischio. Una distribuzione ad alto rischio viene installata automaticamente e può causare risultati imprevisti. Ad esempio, una sequenza di attività con scopo impostato su **Obbligatorio** e che distribuisce Windows 10 viene considerata una distribuzione ad alto rischio. Per altre informazioni, vedere [Impostazioni per gestire distribuzioni ad alto rischio](/sccm/core/servers/manage/settings-to-manage-high-risk-deployments).  
...
5. Nella pagina piano di manutenzione specificare la raccolta di **destinazione**. I membri della raccolta ricevono gli aggiornamenti di Windows 10 definiti nel piano di manutenzione.  
...
8. Nella pagina Pianificazione della distribuzione configurare le seguenti impostazioni:  
   ...
   -   **Scadenza installazione**: selezionare una delle seguenti impostazioni per specificare la scadenza per l'installazione degli aggiornamenti software nella distribuzione:  
       ...
       -   **Ritardare l'imposizione di questa distribuzione in base alle preferenze dell'utente, fino al periodo di tolleranza definito nel client**: selezionare questa opzione per rispettare il [ **periodo di tolleranza per l'imposizione dopo la scadenza della distribuzione (ore)** client impostazione](/sccm/core/clients/deploy/about-client-settings#grace-period-for-enforcement-after-deployment-deadline-hours).
...
Per altre informazioni, vedere [Nozioni di base su Configuration Manager come servizio e Windows come servizio](/sccm/core/understand/configuration-manager-and-windows-as-service).
