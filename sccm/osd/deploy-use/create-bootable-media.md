...
- [Sostituire un computer esistente e trasferire le impostazioni](/sccm/osd/deploy-use/replace-an-existing-computer-and-transfer-settings)  
...
Nell'ambito del supporto di avvio, è necessario specificare la sequenza di attività per distribuire il sistema operativo. Per altre informazioni, vedere [Creare una sequenza di attività per installare un sistema operativo](/sccm/osd/deploy-use/create-a-task-sequence-to-install-an-operating-system).
...
6. Nella pagina **Sicurezza** specificare le opzioni seguenti:  
    ...
    - Per le comunicazioni HTTPS, selezionare **Importa certificato PKI**. Specificare quindi il certificato da importare e la relativa password.  
        ...
        Per altre informazioni su questo certificato client usato dalle immagini di avvio, vedere [Requisiti dei certificati PKI](/sccm/core/plan-design/network/pki-certificate-requirements).  
