...
Per altre informazioni sul supporto di Windows insider in Configuration Manager, vedere [Supporto per Windows 10](/sccm/core/plan-design/configs/support-for-windows-10#bkmk_WIfB-support).
...
- Valutare la possibilità di usare la [priorità dei thread nelle impostazioni client](/sccm/core/clients/deploy/about-client-settings#bkmk_thread-priority).
