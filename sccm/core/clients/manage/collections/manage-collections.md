...
|**Regole di appartenenza**|Consente di configurare le regole di appartenenza che definiscono l'appartenenza di questo insieme. Per altre informazioni, vedere [Come creare le raccolte in System Center Configuration Manager](../../../../core/clients/manage/collections/create-collections.md).|  
|**Risparmio energia**|Consente di configurare i piani di gestione dell'alimentazione assegnati ai computer nella raccolta selezionata. Per altre informazioni, vedere [Introduzione alle raccolte](../../../../core/clients/manage/power/introduction-to-power-management.md).|  
...
|**Variabili raccolta**|Consente di che configurare le variabili che si applicano a questa raccolta e possono essere utilizzate da sequenze di attività. Per altre informazioni, vedere [Variabili predefinite della sequenza di attività](../../../../osd/understand/task-sequence-built-in-variables.md).|  
