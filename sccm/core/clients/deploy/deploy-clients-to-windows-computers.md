...
> [!IMPORTANT]  
> Il push client ha esito positivo solo se sono soddisfatti tutti i prerequisiti. Per altre informazioni, vedere [Dipendenze del metodo di installazione](/sccm/core/clients/deploy/prerequisites-for-deploying-clients-to-windows-computers#installation-method-dependencies).
...
## <a name="BKMK_Provision"></a> Effettuare il provisioning delle proprietà di installazione client
