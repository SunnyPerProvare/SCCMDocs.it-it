---
title: Nozioni fondamentali sulla gestione dei contenuti | System Center Configuration Manager
...
-   **Account di accesso ai pacchetti**: per impostazione predefinita, Configuration Manager concede l'accesso al contenuto in un punto di distribuzione agli account di accesso generici Users e Administrators. È tuttavia possibile configurare autorizzazioni aggiuntive per limitare l'accesso. Vedere &lt;Gestione degli account per accedere al contenuto del pacchetto\>  

-   **Account di connessione multicast** : usato per le distribuzioni di sistemi operativi  

Per altre informazioni sugli account, vedere [Gestione degli account per accedere al contenuto del pacchetto](../../../core/plan-design/hierarchy/manage-accounts-to-access-content.md)
...
Per altre informazioni, vedere [Raccolta contenuto](../../../core/plan-design/hierarchy/the-content-library.md)
...
-   **Punto di distribuzione pull**: variante di un punto di distribuzione in cui il punto di distribuzione ottiene il contenuto da un altro punto di distribuzione (un punto di distribuzione di origine) con modalità analoghe a quelle dei client che scaricano il contenuto dai punti di distribuzione. I punti di distribuzione pull possono risultare utili per evitare i colli di bottiglia della larghezza di banda di rete che possono verificarsi quando il server del sito deve distribuire direttamente il contenuto a ogni punto di distribuzione.  [Usare un punto di distribuzione pull basato sul cloud con System Center Configuration Manager](/sccm/core/plan-design/hierarchy/use-a-pull-distribution-point)  
...
> -   Per altre informazioni, vedere [Usare un punto di distribuzione pull basato sul cloud con System Center Configuration Manager](/sccm/core/plan-design/hierarchy/use-a-pull-distribution-point)  
...
Per informazioni sulle varie posizioni del contenuto e sugli scenari di fallback, vedere [Scenari del percorso di origine del contenuto](../../../core/plan-design/hierarchy/content-source-location-scenarios.md).
...
## <a name="package-transfer-manager"></a>Package Transfer Manager  
 ...
 Altre informazioni: [Package Transfer Manager](../../../core/plan-design/hierarchy/package-transfer-manager.md)  

## <a name="preferred-distribution-point"></a>Punto di distribuzione preferito  
 Punti di distribuzione associati a gruppi di limiti correnti del client.  
