...
> [!Tip]  
> Per spostare il contenuto in un'altra unità nel server del sito, usare lo **strumento per il trasferimento di raccolte di contenuto**. Per altre informazioni, vedere lo [strumento per il trasferimento di raccolte contenuto](/sccm/core/support/content-library-transfer).  
...
> [!Tip]  
> Usare lo strumento **Content Library Explorer** presente negli strumenti di Configuration Manager per visualizzare il contenuto della raccolta contenuto. È possibile usare questo strumento per modificare il contenuto. Fornisce informazioni dettagliate sugli elementi presenti, nonché ne consente la convalida e la ridistribuzione. Per altre informazioni, vedere [Content Library Explorer](/sccm/core/support/content-library-explorer).  
...
- Usare lo strumento [Content Library Explorer](/sccm/core/support/content-library-explorer).  
