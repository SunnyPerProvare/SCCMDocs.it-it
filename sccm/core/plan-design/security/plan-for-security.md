...
### <a name="bkmk_trk-reset"></a> Rimuovere o sostituire la chiave radice attendibile  
 ...
 Per altre informazioni su queste proprietà di installazione, vedere [Informazioni sui parametri e le proprietà di installazione del client](/sccm/core/clients/deploy/about-client-installation-properties).
...
- [Co-gestione](/sccm/core/clients/manage/co-management-overview)  
...
- Ridurre i requisiti di infrastruttura. Usare ad esempio [Software Center tramite il punto di gestione](/sccm/apps/plan-design/plan-for-and-configure-application-management#bkmk_userex) anziché il Catalogo applicazioni  
