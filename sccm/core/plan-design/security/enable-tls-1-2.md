...
- [Aggiornare Windows e WinHTTP in Windows 8.0, Windows Server 2012 (non R2) e versioni precedenti](/sccm/core/plan-design/security/enable-tls-1-2-client#bkmk_winhttp)
- [Assicurarsi che TLS 1.2 sia abilitato come protocollo per SChannel a livello di sistema operativo](/sccm/core/plan-design/security/enable-tls-1-2-client#bkmk_protocol)
- [Aggiornare e configurare .NET Framework per il supporto di TLS 1.2](/sccm/core/plan-design/security/enable-tls-1-2-client#bkmk_net)
...
- [Assicurarsi che TLS 1.2 sia abilitato come protocollo per SChannel a livello di sistema operativo](/sccm/core/plan-design/security/enable-tls-1-2-server#bkmk_protocol)
- [Aggiornare e configurare .NET Framework per il supporto di TLS 1.2](/sccm/core/plan-design/security/enable-tls-1-2-server#bkmk_net)
- [Aggiornare SQL Server e SQL Native Client](/sccm/core/plan-design/security/enable-tls-1-2-server#bkmk_sql)
- [Aggiornare Windows Server Update Services (WSUS)](/sccm/core/plan-design/security/enable-tls-1-2-server#bkmk_wsus)
...
|--- |--- |
|Server del sito (centrale, primario o secondario)| - [Aggiornare .NET Framework](/sccm/core/plan-design/security/enable-tls-1-2-server##bkmk_net)<br/> - Verificare le impostazioni della crittografia complessa|
|Server di database del sito|[Aggiornare SQL Server e i componenti client](/sccm/core/plan-design/security/enable-tls-1-2-server#bkmk_sql)|
|Server del sito secondario|[Aggiornare SQL Server e i componenti client](/sccm/core/plan-design/security/enable-tls-1-2-server#bkmk_sql) a una versione conforme di SQL Express|
|Ruoli del sistema del sito| - [Aggiornare .NET Framework](/sccm/core/plan-design/security/enable-tls-1-2-server#bkmk_net) e verificare le impostazioni della crittografia complessa <br/> - [Aggiornare SQL Server e i componenti client](/sccm/core/plan-design/security/enable-tls-1-2-server#bkmk_sql) per i ruoli che lo richiedono, incluso [SQL Server Native Client](/sccm/core/plan-design/security/enable-tls-1-2-server#bkmk_sql-client)|
|Punto di Reporting Services|- [Aggiornare .NET Framework](/sccm/core/plan-design/security/enable-tls-1-2-server#bkmk_net) nel server del sito, nei server di SQL Reporting Services e nei computer con la console<br/> - Riavviare il servizio SMS_Executive in base alle esigenze|
|Punto di aggiornamento software|[Aggiornare WSUS](/sccm/core/plan-design/security/enable-tls-1-2-server#bkmk_wsus)|
...
|Console di Configuration Manager| - [Aggiornare .NET Framework](/sccm/core/plan-design/security/enable-tls-1-2-client#bkmk_net)<br/> - Verificare le impostazioni della crittografia complessa|
|Client Configuration Manager con ruoli del sistema del sito HTTPS|[Aggiornare Windows per supportare TLS 1.2 per le comunicazioni client-server usando WinHTTP](/sccm/core/plan-design/security/enable-tls-1-2-client#bkmk_winhttp)|
|Software Center| - [Aggiornare .NET Framework](/sccm/core/plan-design/security/enable-tls-1-2-client#bkmk_net)<br/> - Verificare le impostazioni della crittografia complessa|
|Client Windows 7| *Prima* di abilitare TLS 1.2 nei componenti server, [aggiornare Windows per supportare TLS 1.2 per le comunicazioni client-server usando WinHTTP](/sccm/core/plan-design/security/enable-tls-1-2-client#bkmk_winhttp). Se prima si abilita TLS 1.2 nei componenti server, è possibile rendere orfane le versioni precedenti dei client.|
...
- [Abilitare TLS 1.2 nei server del sito](/sccm/core/plan-design/security/enable-tls-1-2-server)
