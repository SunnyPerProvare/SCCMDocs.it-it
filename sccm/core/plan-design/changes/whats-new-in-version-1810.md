...
<!--3607755, fka 1358224-->
***[Aggiornato]*** I siti di amministrazione centrale e i siti primari figlio ora possono avere un altro server del sito in modalità passiva. 
...
<!--3607726, fka 1358981-->
***[Aggiornato]*** Le modifiche seguenti nel comportamento di valutazione delle raccolte possono migliorare le prestazioni del sito:  
...
<!--3607762, fka 1359239-->
***[Aggiornato]*** È possibile usare gli script di Windows PowerShell per i metodi di rilevamento nelle applicazioni e nelle impostazioni negli elementi di configurazione. Quando questi script vengono eseguiti nei client, il client di Configuration Manager ora chiama PowerShell con il parametro `-NoProfile`. Questa opzione avvia PowerShell senza i profili. 
...
***[Aggiornato]***  Sono stati aggiunti ulteriori filtri ai piani di manutenzione di Windows 10. È ora possibile filtrare in base ad **Architettura**, **Categoria prodotto** e allo stato **Sostituito** per l'aggiornamento.
...
<!--vso2839307-->
***[Aggiornato]*** Per controllare il comportamento di installazione degli aggiornamenti software nelle finestre di manutenzione, il gruppo **Aggiornamenti software** include l'impostazione client seguente: 
...
<!--2839349-->
Le attività di pulizia WSUS ora vengono eseguite in siti secondari. Viene eseguita la pulizia WSUS per gli aggiornamenti scaduti e gli aggiornamenti obsoleti vengono rifiutati in Windows Server Update Services per i siti secondari.
...
***[Aggiornato]***  È ora possibile specificare regole di sostituzione per gli aggiornamenti delle funzionalità separatamente dagli aggiornamenti che non riguardano le funzionalità. Questo significa che gli aggiornamenti non verranno rimossi da Configuration Manager prima del completamento della manutenzione dei client Windows 10.
...
<!--3607711, fka 1321523-->
***[AGGIORNATO]***  Il provider SMS fornisce ora l'accesso per l'interoperabilità API di sola lettura a WMI su HTTPS, chiamato il **servizio di amministrazione**. Questa API REST può essere usata al posto di un servizio Web personalizzato per accedere alle informazioni dal sito.
...
L'aggiornamento cumulativo seguente (4486457) è disponibile nella console a partire dal 25 gennaio 2019: [Aggiornamento cumulativo per Configuration Manager Current Branch, versione 1810](https://support.microsoft.com/help/4486457).


### <a name="hotfixes"></a>Aggiornamenti rapidi
