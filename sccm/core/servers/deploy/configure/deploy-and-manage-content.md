...
##  <a name="a-namebkmkdistributea-distribute-content"></a><a name="bkmk_distribute"></a> Distribuire il contenuto  
...
##  <a name="a-namebkmkprestagea-use-prestaged-content"></a><a name="bkmk_prestage"></a> Usare il contenuto pre-installazione  
...
###  <a name="a-namebkmkcreateprestagedcontentfilea-step-1-create-a-prestaged-content-file"></a><a name="BKMK_CreatePrestagedContentFile"></a> Passaggio 1: Creare un file di contenuto pre-installazione  
...
###  <a name="a-namebkmkassigncontenttodistributionpointa-step-2-assign-the-content-to-distribution-points"></a><a name="BKMK_AssignContentToDistributionPoint"></a> Passaggio 2: Assegnare il contenuto ai punti di distribuzione  
...
###  <a name="a-namebkmkexportcontentfromprestagedcontentfilea-step-3-extract-the-content-from-the-prestaged-content-file"></a><a name="BKMK_ExportContentFromPrestagedContentFile"></a> Passaggio 3: Estrarre il contenuto dal file di contenuto pre-installazione  
...
###  <a name="a-namebkmkdpsiteservera-how-to-prestage-content-on-a-distribution-point-on-a-site-server"></a><a name="bkmk_dpsiteserver"></a> Come pre-installare il contenuto in un punto di distribuzione situato in un server del sito  
