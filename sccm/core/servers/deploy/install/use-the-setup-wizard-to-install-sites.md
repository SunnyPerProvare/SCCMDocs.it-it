...
Per espandere un sito primario autonomo, usare la procedura *[Per installare un sito primario o di amministrazione centrale](../../../../core/servers/deploy/install/use-the-setup-wizard-to-install-sites.md#bkmk_installpri)*, illustrata in precedenza in questo articolo.
