...
**Testare l'aggiornamento del database su una copia del backup più recente del database del sito**: prima di aggiornare un sito di amministrazione centrale o un sito primario di System Center Configuration Manager, è possibile testare il processo di aggiornamento del database del sito su una copia di questo database.
