...
Quando si usa la versione Current Branch di Configuration Manager, è possibile installare l'aggiornamento nella console per la versione 1706 per aggiornare la gerarchia da una versione precedente.
...
**Verificare che tutti i siti eseguano una versione di Configuration Manager che supporta l'aggiornamento alla versione 1706:**    
prima di iniziare l'installazione dell'aggiornamento 1706, è necessario che ogni server del sito nella gerarchia esegua la stessa versione di Configuration Manager. Per eseguire l'aggiornamento alla versione 1706, è necessario usare la versione 1606, 1610 o 1702.
