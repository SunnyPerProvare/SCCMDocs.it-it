...
##  <a name="a-namebkmkmanagesmsprovidera-manage-the-sms-provider"></a><a name="BKMK_ManageSMSprovider"></a> Gestire il provider SMS  
...
##  <a name="a-namebkmkconsolea-manage-the-configuration-manager-console"></a><a name="bkmk_Console"></a> Gestire la console di Configuration Manager  
...
###  <a name="a-namebkmkmanageconsolelanguagesa-manage-configuration-manager-console-language"></a><a name="BKMK_ManageConsoleLanguages"></a> Gestire la lingua della console di Configuration Manager  
...
##  <a name="a-namebkmkconfigdcomforremoteconsolea-configure-dcom-permissions-for-remote-configuration-manager-consoles"></a><a name="BKMK_ConfigDCOMforRemoteConsole"></a> Configurare le autorizzazioni DCOM per le console remote di Configuration Manager  
...
##  <a name="a-namebkmkdbconfiga-modify-the-site-database-configuration"></a><a name="bkmk_dbconfig"></a> Modificare la configurazione del database del sito  
...
##  <a name="a-namebkmkspna-manage-the-spn-for-the-site-database-server"></a><a name="bkmk_SPN"></a> Gestire il nome dell'entità servizio (SPN) per il server di database del sito  
...
##  <a name="a-namebkmkreseta-run-a-site-reset"></a><a name="bkmk_reset"></a> Eseguire una reimpostazione del sito  
...
##  <a name="a-namebkmksitelanga-manage-language-packs-at-a-site"></a><a name="bkmk_sitelang"></a> Gestire i Language Pack in un sito  
...
##  <a name="a-namebkmkmoddbalerta-modify-the-database-server-alert-threshold"></a><a name="BKMK_ModDBAlert"></a> Modificare la soglia di avviso del server di database  
