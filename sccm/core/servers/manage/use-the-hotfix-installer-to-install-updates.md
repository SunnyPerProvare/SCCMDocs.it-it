...
##  <a name="a-namebkmkoverviewa-overview-of-hotfixes-for-configuration-manager"></a><a name="bkmk_Overview"></a> Panoramica degli hotfix per Configuration Manager  
...
##  <a name="a-namebkmkinstalla-how-to-install-updates"></a><a name="bkmk_Install"></a> Come installare gli aggiornamenti  
...
###  <a name="a-namebkmkserversa-update-servers"></a><a name="bkmk_servers"></a> Aggiornare i server  
...
####  <a name="a-namebkmksitea-update-a-site"></a><a name="bkmk_site"></a> Aggiornare un sito  
...
####  <a name="a-namebkmkdatabasea-update-a-site-database"></a><a name="bkmk_database"></a> Aggiornare un database del sito  
...
###  <a name="a-namebkmkclientsa-update-clients"></a><a name="BKMK_clients"></a> Aggiornare i client  
...
###  <a name="a-namebkmkconsolea-update-configuration-manager-consoles"></a><a name="BKMK_console"></a> Aggiornare le console di Configuration Manager  
...
##  <a name="a-namebkmkdeploya-deploy-updates-for-configuration-manager"></a><a name="BKMK_Deploy"></a> Distribuire gli aggiornamenti per Configuration Manager  
...
###  <a name="a-namebkmkdeployscupa-use-updates-publisher-2011-to-install-updates"></a><a name="BKMK_DeploySCUP"></a> Usare Updates Publisher 2011 per installare gli aggiornamenti  
...
###  <a name="a-namebkmkdeployswdista-use-software-deployment-to-install-updates"></a><a name="BKMK_DeploySWDist"></a> Usare la distribuzione software per installare gli aggiornamenti  
...
###  <a name="a-namebkmkdeploycollectionsa-create-collections-for-deploying-updates-to-configuration-manager"></a><a name="BKMK_DeployCollections"></a> Creare raccolte per la distribuzione degli aggiornamenti in Configuration Manager  
