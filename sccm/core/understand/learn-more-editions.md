...
Usare questo argomento per informazioni sui requisiti di licenza per le opzioni di installazione disponibili con la versione di ottobre 2016 di System Center Configuration Manager versione 1606, che include Current Branch versione 1606, Long-Term Servicing Branch (LTSB) e l'installazione di valutazione di Current Branch versione 1606.
...
Questo argomento fa riferimento al contratto Software Assurance o a diritti di sottoscrizione equivalenti. Software Assurance è il contratto di licenza Microsoft che concede diritti per l'installazione e l'uso di Configuration Manager.
...
### <a name="software-assurance-and-the-ltsb"></a>Software Assurance e LTSB
 Se si dispone di una sottoscrizione Software Assurance attiva per le licenze di System Center Configuration Manager o di diritti di sottoscrizione equivalenti il 1° ottobre 2016 o in data successiva:
 - È possibile installare e usare LTSB. I clienti che dispongono di diritti perpetui su System Center Configuration Manager o che lasciano scadere la sottoscrizione Software Assurance o equivalente possono installare la versione di System Center Configuration Manager LTSB corrente al momento della scadenza.
...
A partire dalla versione di ottobre 2016 del supporto di base per System Center Configuration Manager versione 1606, è possibile specificare la data di scadenza del contratto Software Assurance. A tale scopo, usare la **data di scadenza di Software Assurance**, un valore facoltativo che è possibile specificare come utile promemoria quando si esegue il programma di installazione di Configuration Manager o in seguito dalla console di Configuration Manager.
