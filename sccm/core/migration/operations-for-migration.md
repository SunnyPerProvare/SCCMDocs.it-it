...
###  <a name="a-namebkmkmodifyexclusionlista-modify-the-exclusion-list-for-migration"></a><a name="BKMK_Modify_Exclusion_List"></a> Modificare l'elenco di esclusione per la migrazione  
...
##  <a name="a-namecompletemigrationa-finish-migration"></a><a name="Complete_Migration"></a> Completare la migrazione  
