...
Per altre informazioni, vedere [Gerarchie di origine](/sccm/core/migration/planning-a-source-hierarchy-strategy#BKMK_Source_Hierarchies).
...
Per altre informazioni, vedere [Siti di origine](/sccm/core/migration/planning-a-source-hierarchy-strategy#BKMK_Source_Sites).
...
Per altre informazioni, vedere [Raccolta dati](/sccm/core/migration/planning-a-source-hierarchy-strategy#BKMK_Data_Gathering).
...
Per altre informazioni, vedere [Pianificazione di una strategia di processo di migrazione](/sccm/core/migration/planning-a-migration-job-strategy).
...
Per altre informazioni, vedere [Pianificazione di una strategia di migrazione client](/sccm/core/migration/planning-a-client-migration-strategy).
...
Per altre informazioni, vedere [Condividere punti di distribuzione tra gerarchie di origine e destinazione](/sccm/core/migration/planning-a-content-deployment-migration-strategy#About_Shared_DPs_in_Migration).
...
Per altre informazioni, vedere [Pianificazione del monitoraggio dell'attività di migrazione](/sccm/core/migration/planning-to-monitor-migration-activity).
...
Per altre informazioni, vedere [Pianificazione del completamento della migrazione](/sccm/core/migration/planning-to-complete-migration).
...
-   [Pianificare la migrazione a Configuration Manager](/sccm/core/migration/planning-for-migration)  

-   [Configurazione di gerarchie di origine e siti di origine per la migrazione](/sccm/core/migration/configuring-source-hierarchies-and-source-sites-for-migration)  

-   [Operazioni per la migrazione](/sccm/core/migration/operations-for-migration)  

-   [Sicurezza e privacy per la migrazione](/sccm/core/migration/security-and-privacy-for-migration)  

-   [Iniziare a usare Configuration Manager](/sccm/core/servers/deploy/start-using)
