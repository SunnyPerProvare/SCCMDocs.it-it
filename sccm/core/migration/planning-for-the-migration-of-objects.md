...
-   [Pianificare la migrazione degli aggiornamenti software](#Plan_migrate_Software_updates)  

-   [Pianificare la migrazione del contenuto](#Plan_Migrate_content)  

-   [Pianificare la migrazione delle raccolte](#BKMK_MigrateCollections)  

-   [Pianificare la migrazione delle distribuzioni del sistema operativo](#Plan_migrate_OSD)  

-   [Pianificare la migrazione della gestione configurazione desiderata](#Plan_Migrate_Compliance_settings)  

-   [Pianificare la migrazione dei limiti](#Plan_migrate_Boundaries)  

-   [Pianificare la migrazione di report](#Plan_Migrate_reports)  

-   [Pianificare la migrazione di cartelle organizzative e di ricerca](#Plan_Migrate_Org_Folders)  

-   [Pianificare la migrazione delle personalizzazioni di Asset Intelligence](#Plan_Migrate_AI)  
