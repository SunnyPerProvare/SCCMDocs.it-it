...
Per ulteriori informazioni su come creare un profilo Wi-Fi in Configuration Manager, vedere [How to create Wi-Fi Profiles](/configmgr/protect/deploy-use/create-wifi-profiles).
