...
1. Scaricare la richiesta di certificato APN.
   ...
   ![Scaricare la richiesta di certificato APN](./media/mdm-change-download-apns-certificate.png)
...
<!--The process is different depending on how to connect to Intune:  
   ...
   ![Caricare il certificato APNs](./media/mdm-change-upload-apns-certificate.png)
