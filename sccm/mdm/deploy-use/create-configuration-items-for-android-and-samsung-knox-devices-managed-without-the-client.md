...
---
# <a name="create-configuration-items-for-android-and-samsung-knox-standard-devices-managed-with-intune"></a>Creare elementi di configurazione per dispositivi Android e Samsung KNOX Standard gestiti con Intune
