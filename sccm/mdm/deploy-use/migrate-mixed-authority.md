...
-   Scenario 2: quando si è pronti a impostare Intune come autorità MDM per il tenant, eseguire le azioni seguenti per completare la migrazione dei dispositivi senza affinità utente:  
