...
- Windows 10
- Windows Phone 8.1
- iPhone che eseguono iOS 9 e versioni successive 
- iPad che eseguono iOS 9 e versioni successive 
...
5. Nella pagina **Exchange ActiveSync** della procedura guidata specificare le informazioni seguenti:  
