...
---
# <a name="how-to-create-configuration-items-for-windows-phone-devices-managed-with-intune"></a>Come creare elementi di configurazione per dispositivi Windows Phone gestiti con Intune
...
|**Tempo di inattività prima del blocco del dispositivo**|Specifica per quanto tempo un dispositivo deve rimanere inattivo prima che lo schermo venga bloccato automaticamente.|  
...
|**Sincronizzazione calendario**|Consente agli utenti di sincronizzare gli appuntamenti del calendario oltre ai messaggi di posta elettronica.|  
...
|Impostazioni|Dettagli|  
|-------------|-------------|  
|**Consenti browser Web**|È possibile modificare il browser Internet predefinito.|  
...
|**Consenti connessione USB**|Controlla se i dispositivi possono accedere a dispositivi di archiviazione esterni tramite una connessone USB.|
