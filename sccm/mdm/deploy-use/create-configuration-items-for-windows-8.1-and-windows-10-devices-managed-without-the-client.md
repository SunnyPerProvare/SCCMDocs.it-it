...
---
# <a name="create-configuration-items-for-windows-81-and-windows-10-devices-managed-with-intune"></a>Creare elementi di configurazione per dispositivi Windows 8.1 e Windows 10 gestiti con Intune
...
|**Complessità password**|Scegliere se è possibile specificare un PIN, ad esempio "1234", o se è necessario fornire una password complessa.<br>(solo Windows 10)|  
...
|**Invia PIN di ripristino password a Exchange Server**|Impostare su **Abilitato** o **Disabilitato**.<br>(solo Windows 10)|  

###  <a name="device"></a>Dispositivo  

|Nome impostazione|Dettagli|  
|------------------|-------------|  
|**Acquisizione schermo**|Consente di acquisire uno screenshot del display del dispositivo.<br> (solo Windows 10)|  
|**Invio dati diagnostici**|Consente l’invio dei file di log dell'app.<br>(solo Windows 8.1)|  
|**Invio dati diagnostici (Windows 10)**|Consente l’invio dei file di log dell'app.<br>(solo Windows 10)|  
|**Georilevazione**|Consente al dispositivo di usare le informazioni dei servizi di posizione.<br>(solo Windows 10)|  
|**Copia e Incolla**|Usare Copia e Incolla per trasferire dati tra app.<br>(solo Windows 10)|
|**Ripristino impostazioni predefinite**|Controlla se l'utente può eseguire il ripristino delle impostazioni di fabbrica del dispositivo.|
...
|Impostazioni|Dettagli|  
|-------------|-------------|  
|**Consenti browser Web**|Consentire l'uso del Web browser nel dispositivo.<br>(solo Windows 10)|  
...
###  <a name="internet-explorer"></a>Internet Explorer  
 Queste impostazioni si riferiscono solo ai dispositivi che eseguono Windows 8.1.  
...
|**Consenti l'invio di traffico Intranet a Internet Explorer**|Consente agli utenti di aprire i siti Intranet in Internet Explorer.|  
...
|**Monitora l'attività di file e programmi**|Abilitare questa impostazione per consentire a Defender di monitorare l'attività di file e programmi sui dispositivi.|
|**File monitorati**|Se l'opzione **Monitora l'attività di file e programmi** è abilitata, è possibile scegliere di monitorare i file in ingresso, quelli in uscita o tutti i file.|
...
|**Consenti l'accesso all'interfaccia utente client**|Controlla se l'interfaccia utente di Windows Defender non è visibile agli utenti finali. Quando questa impostazione viene modificata, le modifiche saranno effettive a partire dal successivo riavvio del PC da parte dell'utente finale.|
...
|**Schedule a quick daily scan** (Pianifica un'analisi giornaliera veloce)|Consente di pianificare un'analisi veloce che viene eseguita giornalmente all'ora selezionata.|
|**Limita utilizzo CPU durante un'analisi**|Consente di limitare la quantità di CPU che le analisi possono usare (da **1** a **100**)|
|**Analizza file di archivio**|Consente a Defender di analizzare i file archiviati come file con estensione zip o cab.|
...
|**Intervallo di aggiornamento della firma**|Specifica l'intervallo con cui Defender controllerà i nuovi file delle firme.|
...
|**Rilevamento di applicazioni potenzialmente indesiderate**|È possibile usare questa impostazione per proteggere i dispositivi con Windows desktop registrati dall'esecuzione di software classificato da Windows Defender come potenzialmente indesiderato. È possibile proteggere queste applicazioni dall'esecuzione o usare la modalità di controllo per segnalare l'installazione di un'applicazione potenzialmente indesiderata.|
|**Esclusioni di file e cartelle**|Aggiungere uno o più file e cartelle come C:\Path o %Programmi%\Path\filename.exe all'elenco delle esclusioni. Questi file e cartelle non verranno inclusi in alcuna scansione in tempo reale o pianificata.|
...
|**Account Microsoft**|Consente di usare un account Microsoft sul dispositivo.<br>(solo Windows 10)|  
...
|Nome impostazione|Dettagli|  
|------------------|-------------|  
|**Installazione file non firmati**|Consente il caricamento di file non firmati.<br>(solo Windows 10)|  
|**Applicazioni non firmate**|Consente il caricamento di file non firmati.<br>(solo Windows 10)|  
|**Messaggistica SMS e MMS**|Consente la messaggistica SMS e MMS dal dispositivo.<br>(solo Windows 10)|  
|**Archivi rimovibili**|Consente di utilizzare archivi rimovibili, ad esempio una scheda SD sul dispositivo.<br> (solo Windows 10)|  
|**Fotocamera**|Consente di utilizzare la fotocamera del dispositivo.<br>(solo Windows 10)|  
|**NFC (Near Field Communication)**|Consente la comunicazione usando NFD nel dispositivo.<br> (solo Windows 10)|  
|**Modalità AntiTheft**|Controlla se è abilitata la modalità AntiTheft di Windows 10.<br>(solo Windows 10)|
|**Consenti connessione USB**|Controlla se i dispositivi possono accedere a dispositivi di archiviazione esterni tramite una connessone USB.<br>(solo Windows 10)|  
|**Tipo profilo**|Fornice un profilo VPN per i dispositivi Windows RT.<br>(Solo Windows 8)|  
|**Nome profilo**|Fornice un profilo VPN per i dispositivi Windows RT.<br>(Solo Windows 8)|  
|**Profilo per tutti gli utenti**|Fornice un profilo VPN per i dispositivi Windows RT.<br>(Solo Windows 8)|  
...
|Nome impostazione|Dettagli|  
|------------------|-------------|  
|**Crittografia scheda di memoria**|Richiede la crittografia delle schede di memoria usate con il dispositivo.<br>(solo Windows 10)|  
|**Crittografia file nel dispositivo mobile**|Richiede la crittografia dei file nel dispositivo.|  
|**Richiedi firma posta elettronica**|Richiede che i messaggi di posta elettronica vengano firmati prima dell'invio.<br>(solo Windows 10)|  
|**Algoritmo di firma**|Selezionare l'algoritmo di firma per i messaggi di posta elettronica firmati.<br>(solo Windows 10)|  
|**Richiedi crittografia posta elettronica**|Richiede che i messaggi di posta elettronica vengano crittografati prima dell'invio.<br>(solo Windows 10)|  
|**Algoritmo di crittografia**|Selezionare l'algoritmo per la crittografia dei messaggi di posta elettronica.<br>(solo Windows 10)|  
...
|**Reporting hotspot Wi-Fi**|Invia informazioni sulle connessioni Wi-Fi per consentire all'utente di individuare connessioni nelle vicinanze.|  
|**Configurazione Wi-Fi manuale**|Controlla se l'utente è in grado di configurare proprie connessioni Wi-Fi o se può usare soltanto connessioni configurate da un profilo Wi-Fi.|  
...
|**Firewall di rete**|Attiva o disattiva Windows Firewall.<br>(solo Windows 8.1)|  
...
|**Aggiornamenti (Windows 10)**|Scegliere come gli aggiornamenti software di Windows verranno scaricati nel computer. Ad esempio, è possibile scaricare automaticamente gli aggiornamenti, ma consentire all'utente di scegliere quando installarli.<br>(solo Windows 10)|  
|**Giorno di installazione**|Scegliere il giorno in cui verranno installati gli aggiornamenti.<br>(solo Windows 10)|  
|**Ora di installazione**|Scegliere l'ora in cui verranno installati gli aggiornamenti.<br>(solo Windows 10)|  
...
|**Funzionalità di versioni non definitive**|Consente a Microsoft di distribuire le impostazioni e le funzionalità della versione non definitiva nel dispositivo.<br>(solo Windows 10)|  
|**Installazione manuale del certificato radice**|(solo Windows 10)|
|**Consenti l'annullamento della registrazione manuale**|Consente all'utente di eliminare manualmente l'account aziendale dal dispositivo.<br>(solo Windows 10)|
