...
---
# <a name="create-configuration-items-for-ios-and-mac-os-x-devices-managed-with-intune"></a>Creare elementi di configurazione per dispositivi iOS e Mac OS X gestiti con Intune
