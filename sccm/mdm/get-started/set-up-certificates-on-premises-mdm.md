...
1. Nella finestra **modello duplicato** selezionare **Windows 2003 Server, Enterprise edition** o **Windows 2008 Server, Enterprise Edition**, quindi fare clic su **OK**.
    ...
    > [!TIP]
    > Configuration Manager supporta i modelli di certificato server Windows 2008, noti anche come certificati V3 o Cryptography: Next Generation (CNG). Per altre informazioni, vedere [Panoramica dei certificati CNG](/configmgr/core/plan-design/network/cng-certificates-overview).
...
> [Impostare la registrazione dei dispositivi](/configmgr/mdm/get-started/set-up-device-enrollment-on-premises-mdm)
